...
variable "db_compartment" {
  type        = string
  description = "The compartment OCID where Siebel DB resides"
}
...
variable "db_cred_compartment" {
  type        = string
  description = "The compartment OCID where Siebel DB password secret resides"
}
...
variable "db_host" {
  type        = string
  description = "Siebel DB Host"
}

variable "db_port" {
  type        = number
  description = "Siebel DB Port"
}

variable "db_service" {
  type        = string
  description = "Siebel DB Service Name"
}


variable "db_credentials" {
  type        = string
  description = "OCID of secret in vault to use for connecting to Siebel DB"
}

variable "db_username" {
  type        = string
  description = "Username for connecting to Siebel DB"
}
...
variable "la_entity_name" {
  type        = string
  default     = "TestSiebel"
  description = "The Siebel Entity Name."
}
...
variable "dashboard_files" {
  ...
  type = set(string)
  default = ["Siebel-Dashboards.json"]
  #default = ["Siebel-sensors-dashboard.json"]
}
